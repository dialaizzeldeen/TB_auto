...
{
	public static String desc = "product-description";
	
	//TODO: remove var below 
	...
	public static String rating = "css,.BVRRPrimarySummary .BVRRRatingSummaryLinks .BVRRNonZeroCount";
